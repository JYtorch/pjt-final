...
<div class="page-single">
	<div class="container">
		<div class="row">
          ...
          <div>
					  <span class="time">27 Mar 2017</span> <span class="right-it" style="font-family: Nunito;">좋아요</span>
          </div>
          <hr>
					<img src="images/uploads/blog-detail.jpg" alt="">
					<!-- <p>Joss Whedon has a little bit of a history with superhero movies, and for creating layered female characters. After his documented frustrations with Wonder Woman, he's getting another chance at the DC Extended Universe and Warner Bros., closing in on a deal to write direct and produce a Batgirl movie.</p>					
...
export default {
  components: { CommunitySidebar, CommentItems, CommentForm },
  name: 'ReviewDetail',
  data () {
    return {
      messageInfo: [],
