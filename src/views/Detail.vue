			...
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="movie-single-ct main-content">
					...
					<div class="movie-rate">
						...
						<div class="rate-star">
							<p>Rate This Movie:  </p>
							<i v-for="(star, index) in Math.round(movie.vote_average)" :key="index" class="ion-ios-star"></i>	
							<i v-for="(star, index) in 10 - Math.round(movie.vote_average)" :key="index" class="ion-ios-star-outline"></i>
						</div>
					</div>
					...
					<div class="movie-tabs">
						<div class="tabs">
						    ...
						    <div class="tab-content">
									...
									<!-- 줄거리 -->
						        <div v-if="currentTab == 0" id="overview" class="">
						            <div class="row">
						            	<div class="col-md-8 col-sm-12 col-xs-12">
						            		<p>{{ movie.overview }}</p>
									...
									<!-- 리뷰 -->
						        <div v-if="currentTab == 1" id="reviews" class="">
						           <div class="row">
						            	<div class="rv-hd">
						            		<!-- <div class="div">
									...
									<!-- 배우 -->
						        <div v-if="currentTab == 2" id="cast" class="">
						        	<div class="row">
						            	<!-- <h3>Cast & Crew of</h3>
									...
									<!-- 미디어 -->
					       	 	<div v-if="currentTab == 3" id="media" class="">
						        	<div class="row">
						        		<div class="rv-hd">
						            		<div>
									...
									<!-- 관련 영화 -->
					       	 	<div v-if="currentTab == 4" id="moviesrelated" class="">
					       	 		<div class="row">
					       	 			<!-- <h3>Related Movies To</h3>
					       	 			<h2>Skyfall: Quantum of Spectre</h2> -->
					       	 			<div class="topbar-filter">
